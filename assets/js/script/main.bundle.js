...
/*!****************************!*\
  !*** ./src/ajax-module.js ***!
  \****************************/
/*! exports provided: AjaxQuery, SetAjaxConfig */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"AjaxQuery\", function() { return AjaxQuery; });\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"SetAjaxConfig\", function() { return SetAjaxConfig; });\nvar AjaxQuery = function () {\n  var running = false; // Ajax Running\n\n  return {\n    \"sendAjax\": function sendAjax(config) {\n      var wait = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : true;\n\n      if (!running && wait) {\n        // Set running jadi true\n        var j = function j() {\n          return $.ajax(config);\n        };\n\n        running = true;\n        $.when(j()).done(function () {\n          running = false;\n        });\n      } else {\n        $.ajax(config);\n      }\n    }\n  };\n}();\nvar SetAjaxConfig = function SetAjaxConfig() {\n  for (var _len = arguments.length, args = new Array(_len), _key = 0; _key < _len; _key++) {\n    args[_key] = arguments[_key];\n  }\n\n  var ajax = {\n    \"url\": \"\",\n    \"data\": {},\n    \"processData\": false,\n    \"cache\": false,\n    \"dataType\": \"JSON\",\n    \"type\": \"POST\"\n  };\n  var redirect = \"\";\n  var config = arguments;\n  var data = Object.create(null);\n\n  var getConfig = function getConfig() {\n    return ajax;\n  };\n\n  var setConfig = function setConfig() {\n    for (var _len2 = arguments.length, args = new Array(_len2), _key2 = 0; _key2 < _len2; _key2++) {\n      args[_key2] = arguments[_key2];\n    }\n\n    if (arguments.length > 0) {\n      if (arguments[0] instanceof Object) {\n        ajax = arguments[0];\n      } else {\n        if (arguments[0] != \"\" && arguments[1] != \"\") {\n          console.log(arguments[1]);\n          ajax[arguments[0]] = arguments[1];\n        }\n      }\n    }\n  };\n\n  var setData = function setData(data) {\n    data = data;\n  };\n\n  var setSuccess = function setSuccess(fn) {\n    var show = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : true;\n    var redirect = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : \"\";\n    ajax.redirect = redirect;\n\n    if (show && fn instanceof Function) {\n      ajax.success = fn;\n    } else {\n      ajax.success = function () {\n        if (redirect != \"\") {\n          location.href = redirect;\n        }\n      };\n    }\n  };\n\n  var setError = function setError(fn) {\n    var show = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : true;\n\n    if (show && fn instanceof Function) {\n      ajax.error = fn;\n    } else {\n      ajax.error = function () {};\n    }\n  };\n\n  var setBeforeSend = function setBeforeSend(fn) {\n    if (fn instanceof Function) {\n      ajax.beforeSend = fn;\n    }\n  };\n\n  var setComplete = function setComplete(fn) {\n    if (fn instanceof Function) {\n      ajax.complete = fn;\n    }\n  };\n\n  var setRedirect = function setRedirect(path) {\n    redirect = path;\n  };\n\n  return {\n    \"getConfig\": getConfig,\n    \"setConfig\": setConfig,\n    \"setData\": setData,\n    \"setSuccess\": setSuccess,\n    \"setError\": setError,\n    \"setRedirect\": setRedirect,\n    \"setBeforeSend\": setBeforeSend,\n    \"setComplete\": setComplete\n  };\n};\n\n//# sourceURL=webpack:///./src/ajax-module.js?");

/***/ }),

/***/ "./src/command-module.js":
/*!*******************************!*\
  !*** ./src/command-module.js ***!
  \*******************************/
/*! exports provided: ToggleSideBarAnimCommand, ToggleSidebarDropdownCommand, SubmitGetFormCommand, ShowPasswordCommand, OffCollapseElementCommand, AddImgUploadListQueueCommand, RemoveProductImageCommand, ToggleUserMenuPanelCommand, AddSubCategoryInputCommand, RemoveCategoryCommand, RemoveSubCategoryInputCommand, RemoveSubCategoryCommand, MoneyFormatRupiahInputCommand, RemoveContentFromDOMCommand, RemoveFileFromSessionStorageCommand, RemoveProductFromDetailCommand, ShowCurrentImageCommand, RemoveProductCommand, closeNotification, Event */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"ToggleSideBarAnimCommand\", function() { return ToggleSideBarAnimCommand; });\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"ToggleSidebarDropdownCommand\", function() { return ToggleSidebarDropdownCommand; });\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"SubmitGetFormCommand\", function() { return SubmitGetFormCommand; });\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"ShowPasswordCommand\", function() { return ShowPasswordCommand; });\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"OffCollapseElementCommand\", function() { return OffCollapseElementCommand; });\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"AddImgUploadListQueueCommand\", function() { return AddImgUploadListQueueCommand; });\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"RemoveProductImageCommand\", function() { return RemoveProductImageCommand; });\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"ToggleUserMenuPanelCommand\", function() { return ToggleUserMenuPanelCommand; });\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"AddSubCategoryInputCommand\", function() { return AddSubCategoryInputCommand; });\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"RemoveCategoryCommand\", function() { return RemoveCategoryCommand; });\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"RemoveSubCategoryInputCommand\", function() { return RemoveSubCategoryInputCommand; });\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"RemoveSubCategoryCommand\", function() { return RemoveSubCategoryCommand; });\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"MoneyFormatRupiahInputCommand\", function() { return MoneyFormatRupiahInputCommand; });\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"RemoveContentFromDOMCommand\", function() { return RemoveContentFromDOMCommand; });\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"RemoveFileFromSessionStorageCommand\", function() { return RemoveFileFromSessionStorageCommand; });\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"RemoveProductFromDetailCommand\", function() { return RemoveProductFromDetailCommand; });\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"ShowCurrentImageCommand\", function() { return ShowCurrentImageCommand; });\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"RemoveProductCommand\", function() { return RemoveProductCommand; });\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"closeNotification\", function() { return closeNotification; });\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"Event\", function() { return Event; });\nfunction asyncGeneratorStep(gen, resolve, reject, _next, _throw, key, arg) { try { var info = gen[key](arg); var value = info.value; } catch (error) { reject(error); return; } if (info.done) { resolve(value); } else { Promise.resolve(value).then(_next, _throw); } }\n\nfunction _asyncToGenerator(fn) { return function () { var self = this, args = arguments; return new Promise(function (resolve, reject) { var gen = fn.apply(self, args); function _next(value) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, \"next\", value); } function _throw(err) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, \"throw\", err); } _next(undefined); }); }; }\n\n// Command Module\nvar Command = function Command(cmd) {\n  var value = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : \"\";\n  var config = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : {};\n  this.cmd = cmd;\n  this.cmdValue = value;\n  this.config = config;\n\n  this.execute = function () {\n    if (this.cmdValue == \"\" || this.cmdValue.length == 0 || objectLength(this.cmdValue) == 0 && !this.cmdValue instanceof Element) {\n      this.cmd();\n    } else {\n      if (objectLength(this.config) > 0) {\n        this.cmd.call({}, this.cmdValue, this.config);\n      } else {\n        this.cmd.call({}, this.cmdValue);\n      }\n    }\n  };\n}; // Toggle sidebar dengan animasi command\n\n\nvar ToggleSideBarAnimCommand = function ToggleSideBarAnimCommand(elem) {\n  return new Command(toggleSidebarAnim, elem);\n}; // Toggle sidebar dropdown command\n\nvar ToggleSidebarDropdownCommand = function ToggleSidebarDropdownCommand(elem) {\n  return new Command(toggleSidebarDropdown, elem);\n}; // Submit Get Form dan bersihkan value kosong saat submit\n\nvar SubmitGetFormCommand = function SubmitGetFormCommand(elem) {\n  return new Command(submitGetForm, elem);\n};\nvar ShowPasswordCommand = function ShowPasswordCommand(elem) {\n  return new Command(showPassword, elem);\n}; // Perintah untuk menutup element seperti user panel ketika user klik diluar konten tersebut\n\nvar OffCollapseElementCommand = function OffCollapseElementCommand(data) {\n  if (data instanceof Object) {\n    var match;\n\n    (function () {\n      var eventTarget = data.eventTarget;\n      var targetList = data.targetList;\n      var excludeTarget = data.excludeTarget;\n      match = false;\n\n      for (var i = 0; i < excludeTarget.length; i++) {\n        if ($(excludeTarget[i]).find($(eventTarget)).length >= 1 || $(excludeTarget[i]).is($(eventTarget))) {\n          match = true;\n        }\n\n        $(excludeTarget[i]).children().each(function (index, elem) {\n          if ($(elem).find(eventTarget).length >= 1) {\n            match = true;\n            return;\n          }\n        });\n      }\n\n      if (!match) {\n        for (var a = 0; a < targetList.length; a++) {\n          Event.execute(new targetList[a].command({\n            'target': targetList[a].target,\n            'collapse': targetList[a].collapse\n          }));\n        }\n      }\n    })();\n  }\n}; // Tambahkan gambar dari input type file ke daftar gambar yang akan diupload\n\nvar AddImgUploadListQueueCommand = function AddImgUploadListQueueCommand(elem) {\n  return new Command(addImgUploadListQueue, elem);\n};\nvar RemoveProductImageCommand = function RemoveProductImageCommand(elem, config) {\n  return new Command(removeProductImage, elem, config);\n};\nvar ToggleUserMenuPanelCommand = function ToggleUserMenuPanelCommand(elem) {\n  return new Command(toggleUserMenuPanel, elem);\n}; // Tambah input sub kategori input command\n\nvar AddSubCategoryInputCommand = function AddSubCategoryInputCommand(elem) {\n  return new Command(addSubCategoryInput, elem);\n}; // Hapus kategori command\n\nvar RemoveCategoryCommand = function RemoveCategoryCommand(elem, config) {\n  return new Command(removeCategory, elem, config);\n};\nvar RemoveSubCategoryInputCommand = function RemoveSubCategoryInputCommand(elem) {\n  return new Command(removeSubCategoryInput, elem);\n}; // Hapus sub kategori command\n\nvar RemoveSubCategoryCommand = function RemoveSubCategoryCommand(elem, config) {\n  return new Command(removeSubCategory, elem, config);\n}; // Input uang format rupiah command\n\nvar MoneyFormatRupiahInputCommand = function MoneyFormatRupiahInputCommand(value) {\n  return new Command(moneyFormatRupiahInput, value);\n}; // Command untuk menghapus content saat diklik\n\nvar RemoveContentFromDOMCommand = function RemoveContentFromDOMCommand(value) {\n  var t = value;\n  return new Command(removeContentFromDOM, t);\n}; // Command untuk menghapus file dari sessionStorage\n\nvar RemoveFileFromSessionStorageCommand = function RemoveFileFromSessionStorageCommand(value) {\n  return new Command(removeFileFromSessionStorage, value);\n};\nvar RemoveProductFromDetailCommand = function RemoveProductFromDetailCommand(element, config) {\n  return new Command(removeProductFromDetail, element, config);\n};\nvar ShowCurrentImageCommand = function ShowCurrentImageCommand(element) {\n  return new Command(showCurrentImage, element);\n};\nvar RemoveProductCommand = function RemoveProductCommand(element, config) {\n  return new Command(removeProduct, element, config);\n}; // Hapus gambar produk\n\nfunction removeProductImage(element, config) {\n  var ConfirmationDialog = config.confirmationDialog;\n  var file_name = $(element).attr('data-image');\n  ConfirmationDialog.prependModal();\n  ConfirmationDialog.setModalMessage(\"Apakah anda ingin menghapus data?\");\n  ConfirmationDialog.setModalFooterButton(\"Iya\", 'primary', true);\n  ConfirmationDialog.setModalFooterButton(\"Tidak\", 'danger', true);\n  ConfirmationDialog.showModal();\n  $(document).on('click', '.btn-confirmation', function (p) {\n    if ($(this).attr('data-answer') === 'yes') {\n      var data = new FormData();\n      data.append('gambar', file_name);\n      var url = base_url(\"produk/hapus_gambar_produk\"); // URL target\n\n      var ajaxConfig = config.ajaxConfig;\n      var ajaxModule = config.ajaxModule;\n      ajaxConfig.setConfig({\n        'url': url,\n        'data': data,\n        'type': \"POST\",\n        'dataType': \"JSON\",\n        'processData': false,\n        'contentType': false,\n        'cache': false,\n        'clickedElement': element\n      });\n      ajaxConfig.setBeforeSend(ajaxDeleteBefore); // Set BeforeSend\n\n      ajaxConfig.setComplete(ajaxDeleteComplete); // Set Complete\n\n      ajaxConfig.setSuccess(ajaxDeleteSuccess, true); // Atur fungsi Sukses\n\n      ajaxConfig.setError(ajaxDeleteError); // Atur fungsi error\n\n      ajaxModule.AjaxQuery.sendAjax(ajaxConfig.getConfig()); // Kirim ajax\n    }\n\n    $(document).off('click', '.btn-confirmation');\n  });\n} // Hapus Produk dari daftar produk\n\n\nfunction removeProduct(element, config) {\n  var ConfirmationDialog = config.confirmationDialog;\n  var idProduct = $(element).attr('data-id-produk');\n  ConfirmationDialog.prependModal(); // Menambahkan modal ke DOM HTML\n\n  ConfirmationDialog.setModalMessage(\"Apakah anda ingin menghapus data?\");\n  ConfirmationDialog.setModalFooterButton(\"Iya\", 'primary', true);\n  ConfirmationDialog.setModalFooterButton(\"Tidak\", 'danger', true);\n  ConfirmationDialog.showModal();\n  $(document).on('click', '.btn-confirmation', function (p) {\n    if ($(this).attr('data-answer') === 'yes') {\n      var page = getGETURLParameter(\"page\");\n      var per_page = getGETURLParameter(\"per_page\");\n      var id_subkategori_input = getGETURLParameter(\"id_subkategori_input\");\n      var search_product_name = getGETURLParameter(\"search_product_name\");\n      var data = {\n        'idProduk': idProduct\n      };\n\n      if (page != \"\") {\n        data['page'] = page;\n      }\n\n      if (per_page != \"\") {\n        data['per_page'] = per_page;\n      }\n\n      if (id_subkategori_input != \"\") {\n        data['id_subkategori_input'] = id_subkategori_input;\n      }\n\n      if (search_product_name != \"\") {\n        data['search_product_name'] = search_product_name;\n      }\n\n      $.getJSON(base_url(\"produk/input_hapus_produk\"), data).done(function (data) {\n        $(element).parents('.product-list').fadeOut('slow', function () {\n          $(this).remove();\n          ajaxGetJSONRemoveProductDone(data);\n        });\n      }).fail(ajaxGetJSONRemoveProductFail);\n    }\n\n    $(document).off('click', '.btn-confirmation');\n  });\n} // Hapus produk tanpa ajax\n\n\nfunction removeProductFromDetail(elem, config) {\n  var ConfirmationDialog = config.confirmationDialog;\n  var url = $(elem).attr('href');\n  ConfirmationDialog.prependModal(); // Menambahkan modal ke DOM HTML\n\n  ConfirmationDialog.setModalMessage(\"Apakah anda ingin menghapus data?\");\n  ConfirmationDialog.setModalFooterButton(\"Iya\", 'primary', true);\n  ConfirmationDialog.setModalFooterButton(\"Tidak\", 'danger', true);\n  ConfirmationDialog.showModal();\n  $(document).on('click', '.btn-confirmation', function (p) {\n    if ($(this).attr('data-answer') === 'yes') {\n      window.location.href = url;\n    }\n\n    $(document).off('click', '.btn-confirmation'); // Hapus event click pada tombol konfirmasi modal saat modal selesai diklik\n  });\n}\n\nfunction showCurrentImage(element) {\n  var target = $(element).attr('data-image-preview-target');\n\n  if (!$(target).hasClass('img-list-box-active')) {\n    $('.img-list-box').removeClass('img-list-box-active');\n    $(\"#\".concat(target)).attr('src', $(element).find('img').attr('src'));\n    $(element).addClass('img-list-box-active');\n  }\n} // Hapus file dari sessionStorage\n\n\nfunction removeFileFromSessionStorage(element) {\n  var fileName = $(element).attr('data-file-name');\n\n  if ((fileName != undefined || fileName != null) && (sessionStorage.getItem('files') != null || sessionStorage.getItem('files') != undefined)) {\n    var files = JSON.parse(sessionStorage.getItem('files'));\n    delete files[\"\".concat(fileName)];\n\n    if (objectLength(files) == 0) {\n      sessionStorage.removeItem('files');\n    } else {\n      sessionStorage.setItem('files', JSON.stringify(files));\n    }\n  }\n}\n\nfunction removeContentFromDOM(element) {\n  var target = $(element).attr('data-target');\n  var parentContainer = $(element).attr('data-parent-container-target');\n  var remove = \"\";\n\n  if ($(element).closest(\".\".concat(target)).length > 0) {\n    $(element).closest(\".\".concat(target)).fadeOut('slow', function () {\n      $(this).remove();\n    });\n  } else if ($(element).children().find(\".\".concat(target)).length > 0) {\n    $(element).children().find(\".\".concat(target)).fadeOut('slow', function () {\n      $(this).remove();\n    });\n  }\n}\n\n;\n\nfunction addImgUploadListQueue(elem) {\n  var files = $(elem.target).prop('files');\n  var file_type = [];\n  var file_store = sessionStorage.getItem('files') == undefined ? Object.create(null) : JSON.parse(sessionStorage.getItem('files'));\n\n  for (var x = 0; x < files.length; x++) {\n    (function () {\n      var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2(x) {\n        return regeneratorRuntime.wrap(function _callee2$(_context2) {\n          while (1) {\n            switch (_context2.prev = _context2.next) {\n              case 0:\n                _context2.next = 2;\n                return checkImgMimeType(files[x]).then( /*#__PURE__*/function () {\n                  var _ref2 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(fullfill) {\n                    var msg, notification, error, randomName, tmp, p, element, parent;\n                    return regeneratorRuntime.wrap(function _callee$(_context) {\n                      while (1) {\n                        switch (_context.prev = _context.next) {\n                          case 0:\n                            msg = [];\n                            notification = \"\";\n                            error = false;\n                            randomName = randomUniqueID();\n\n                            if (fullfill == 'unknown_file') {\n                              error = true;\n                              msg.push(\"Format file harus berupa .jpg, dan .png\");\n                            }\n\n                            if (files[x].size > 2097152) {\n                              error = true;\n                              msg.push(\"Ukuran file maksimal 2MB\");\n                            }\n\n                            if (error) {\n                              _context.next = 11;\n                              break;\n                            }\n\n                            _context.next = 9;\n                            return imgToBase64(files[x]);\n\n                          case 9:\n                            file_store[\"\".concat(randomName)] = _context.sent;\n                            sessionStorage.setItem('files', JSON.stringify(file_store));\n\n                          case 11:\n                            if (msg.length > 0 && error) {\n                              tmp = \"\";\n\n                              for (p = 0; p < msg.length; p++) {\n                                tmp += \"\\n                            <div><span>\".concat(msg[p], \"</span></div>\\n                        \");\n                              }\n\n                              notification = \"\\n                    <div class=\\\"card-body rounded-0 alert alert-danger pb-0 mb-0\\\">\\n                        <span>Error Terjadi</span>\\n                        \".concat(tmp, \"\\n                    </div>\\n                    \");\n                            }\n\n                            element = \"\\n                    <div class=\\\"col-lg-12 mb-2 px-0 list-container\\\">\\n                        <div class=\\\"card rounded-0 \".concat(randomName, \"\\\">\\n                            <div class=\\\"list-header font-md py-3 px-3\\\">\\n                                <div class=\\\"position-relative w-100\\\">\\n                                    <span class=\\\"link-title\\\">\").concat(files[x].name, \"</span>\\n                                    <span class=\\\"position-absolute close-list remove-element cursor-pointer hover-red\\\" data-target=\\\"list-container\\\" data-parent-container-target=\\\"img-uploaded-list-container\\\" data-file-name=\\\"\").concat(randomName, \"\\\" style=\\\"right: 2px; top: 50%; transform: translateY(-50%);\\\"><i class=\\\"fa fa-fw fa-times\\\"></i></span>\\n                                </div>\\n                            </div>\\n                            \").concat(notification, \"\\n                        </div>\\n                    </div>\\n                \");\n                            parent = $('.file-upload-style').parent();\n\n                            if ($(parent).find('.img-uploaded-list-container').length == 0) {\n                              $(parent).append(\"<div class=\\\"mt-2 mb-2 w-100 img-uploaded-list-container\\\"></div>\");\n                            }\n\n                            $('.img-uploaded-list-container').append(element);\n\n                          case 16:\n                          case \"end\":\n                            return _context.stop();\n                        }\n                      }\n                    }, _callee);\n                  }));\n\n                  return function (_x2) {\n                    return _ref2.apply(this, arguments);\n                  };\n                }());\n\n              case 2:\n              case \"end\":\n                return _context2.stop();\n            }\n          }\n        }, _callee2);\n      }));\n\n      return function (_x) {\n        return _ref.apply(this, arguments);\n      };\n    })()(x);\n  }\n} // Konversi input angka ke format uang rupiah\n\n\nfunction moneyFormatRupiahInput(value) {\n  var target = value.target;\n  var targetPos = target.selectionStart;\n  var targetVal = $(target).val();\n  targetVal = targetVal.replace(/[a-zA-Z\\!@#$%^&\\*\\(\\)\\_\\+\\-\\=\\{\\}\\[\\]\\|\\\\\\:\\;\\\"\\'\\<\\>\\?\\/]/g, \"\").trim();\n  var rupiah;\n  var rupiahLength = 0;\n\n  if (targetVal != \"\") {\n    rupiah = rupiahFormat(targetVal);\n    rupiahLength = rupiah.length;\n    $(target).val(rupiah);\n  }\n\n  if (targetPos != rupiahLength) {\n    if (rupiahLength > targetVal.length) {\n      targetPos += 1;\n    } else if (rupiahLength < targetVal.length) {\n      if (targetPos - 1 > 0) {\n        targetPos -= 1;\n      }\n    }\n  }\n\n  target.selectionEnd = targetPos;\n} // Hapus subkategori\n\n\nfunction removeSubCategory(elem, config) {\n  var ConfirmationDialog = config.confirmationDialog;\n  var ajaxConfig = config.ajaxConfig;\n  var ajaxModule = config.ajaxModule;\n  var target = $(elem).attr('data-target');\n  var targetContainer = $(elem).attr('data-target2');\n  var idSubKategori = $(elem).attr('data-id-subkategori');\n  ConfirmationDialog.prependModal();\n  ConfirmationDialog.setModalMessage(\"Apakah anda ingin menghapus data?\");\n  ConfirmationDialog.setDangerMessage(\"Peringatan menghapus data sub kategori juga akan menghapus data produk!\");\n  ConfirmationDialog.setModalFooterButton(\"Iya\", 'primary', true);\n  ConfirmationDialog.setModalFooterButton(\"Tidak\", 'danger', true);\n  ConfirmationDialog.showModal(); // Hapus modal dari DOM setelah diklik\n\n  $(document).on('click', '.btn-confirmation', function (p) {\n    if ($(this).attr('data-answer') === 'yes') {\n      // Hapus element subkateogri dari DOM!\n      $(elem).parents(\".\".concat(target)).fadeOut('slow', function () {\n        $(this).remove();\n      }); // Hapus element kategori dari DOM jika subkategori sudah tidak ada lagi!\n\n      if ($(elem).parents('.list-content').children(\".\".concat(target)).length - 1 <= 0) {\n        $(elem).parents(\".\".concat(targetContainer)).fadeOut('slow', function () {\n          $(this).remove();\n        });\n      }\n\n      var pageNumber = getGETURLParameter('page=') != \"\" ? getGETURLParameter('page=') : 1;\n      pageNumber = !isNaN(pageNumber) ? parseInt(pageNumber) : 1;\n      var data = new FormData();\n      data.append('idSubKategori', idSubKategori);\n      data.append('page', pageNumber);\n      data.append('kategoriElementTotal', $('.list-container').length);\n      var url = base_url(\"kategori_produk/hapus_subkategori_produk?page=\" + pageNumber); // URL target\n\n      ajaxConfig.setConfig({\n        'url': url,\n        'data': data,\n        'type': \"POST\",\n        'dataType': \"JSON\",\n        'processData': false,\n        'contentType': false,\n        'cache': false\n      });\n      ajaxConfig.setBeforeSend(ajaxDeleteBefore); // Set BeforeSend\n\n      ajaxConfig.setComplete(ajaxDeleteComplete); // Set Complete\n\n      ajaxConfig.setSuccess(ajaxDeleteSuccess, true); // Atur fungsi Sukses\n\n      ajaxConfig.setError(ajaxDeleteError); // Atur fungsi error\n\n      ajaxModule.AjaxQuery.sendAjax(ajaxConfig.getConfig()); // Kirim ajax\n    }\n\n    $(document).off('click', '.btn-confirmation'); // Hapus event click pada tombol konfirmasi modal\n  });\n} // Hapus kategori\n\n\nfunction removeCategory(elem, config) {\n  var ConfirmationDialog = config.confirmationDialog;\n  var ajaxConfig = config.ajaxConfig;\n  var ajaxModule = config.ajaxModule;\n  var target = $(elem).attr('data-target');\n  var btn = $(elem);\n  var idKategori = $(btn).parents('.list-container').attr(\"data-idkategori\");\n  ConfirmationDialog.prependModal(); // Tambahkan modal pada child element pertama pada body\n\n  ConfirmationDialog.setModalMessage(\"Apakah anda ingin menghapus data?\");\n  ConfirmationDialog.setDangerMessage(\"Peringatan menghapus data kategori juga akan menghapus data subkategori, dan produk!\");\n  ConfirmationDialog.setModalFooterButton(\"Iya\", 'primary', true);\n  ConfirmationDialog.setModalFooterButton(\"Tidak\", 'danger', true);\n  ConfirmationDialog.showModal(); // Hapus modal dari DOM saat modal ditutup\n\n  $(document).on('click', '.btn-confirmation', function (p) {\n    if ($(this).attr('data-answer') === 'yes') {\n      $(btn).parents(\".\".concat(target)).fadeOut('slow', function () {\n        $(this).remove();\n        var pageNumber = getGETURLParameter('page=') != \"\" ? getGETURLParameter('page=') : 1;\n        pageNumber = !isNaN(pageNumber) ? parseInt(pageNumber) : 1;\n        var data = new FormData();\n        data.append('idKategori', idKategori);\n        data.append('page', pageNumber);\n        data.append('kategoriElementTotal', $('.list-container').length);\n        var url = base_url(\"kategori_produk/hapus_kategori_produk?page=\" + pageNumber); // URL target\n\n        ajaxConfig.setConfig({\n          'url': url,\n          'data': data,\n          'type': \"POST\",\n          'dataType': \"JSON\",\n          'processData': false,\n          'contentType': false,\n          'cache': false,\n          'targetRemove': $(elem).attr('data-target-remove')\n        });\n        ajaxConfig.setBeforeSend(ajaxDeleteBefore); // Set BeforeSend\n\n        ajaxConfig.setComplete(ajaxDeleteComplete); // Set Complete\n\n        ajaxConfig.setSuccess(ajaxDeleteSuccess, true); // Atur fungsi Sukses\n\n        ajaxConfig.setError(ajaxDeleteError); // Atur fungsi error\n\n        ajaxModule.AjaxQuery.sendAjax(ajaxConfig.getConfig()); // Kirim ajax\n      });\n    }\n\n    $(document).off('click', '.btn-confirmation'); // Hapus event click pada tombol konfirmasi modal\n  });\n}\n\nfunction submitGetForm(elem) {\n  $(elem).find('input, select').each(function () {\n    if ($(this).val().trim() == \"\") {\n      $(this).attr('disabled', true);\n    }\n  });\n} // Tambah input sub kategori\n\n\nfunction addSubCategoryInput(elem) {\n  var target = \".\".concat($(elem).attr('data-target'));\n  var targetLink = \".\".concat($(elem).attr('data-target-link'));\n  var index = isNaN(parseInt($(target).last().attr('data-subkategori-input-index'))) == false ? parseInt($(target).last().attr('data-subkategori-input-index')) + 1 : 1;\n\n  if ($(target).length <= 9) {\n    var subKategoriBox = \"\\n        <div class=\\\"mt-2 mb-2 subkategori-box\\\">\\n            <div class=\\\"card rounded-0\\\">\\n                <div class=\\\"card-body\\\">\\n                    <button type='button' class=\\\"btn-hapus-subkategori-input rounded-0 btn btn-danger\\\"><i class=\\\"fa fa-fw fa-times\\\"></i> Hapus Input Sub Kategori</button>\\n                    <div class=\\\"mt-4 appended-input\\\">\\n                        <h5 class=\\\"appended-input-title\\\">Sub Kategori Input \".concat(index, \"</h5>\\n                        <div class=\\\"mb-2\\\">\\n                            <span>Nama Sub Kategori</span>\\n                        </div>\\n                    </div>\\n                </div>\\n            </div>\\n        </div>\\n    \"); // const targetLastIndex = $(target).attr('data-subkategori-input-index');\n\n    $(subKategoriBox).hide().appendTo('#inputSection'); // Sembunyikan kotaknya\n\n    $('.appended-input:last').append('<div class=\"input-box mb-2\"></div><div class=\"mb-2\"><span>Link Sub Kategori</span></div><div class=\"input-box\"></div>');\n    $('.appended-input:last').append('');\n    $(target).last().clone().appendTo('.appended-input:last .input-box:first'); // Tambah input dengan copy dari input subkategori terakhir\n\n    $('.appended-input:last .input-box').first().append(\"<span id=\\\"subKategoriInput\".concat(index, \"Error\\\" class=\\\"input-error text-danger\\\"></span>\"));\n    $(target).last().val('');\n    $(targetLink).last().clone().appendTo('.input-box:last'); // Tambah input link dengan copy dari input subkategori link terakhir\n\n    $(targetLink).last().val('');\n    $('.input-box').last().append(\"<span id=\\\"subKategoriLinkInput\".concat(index, \"Error\\\" class=\\\"input-link-error input-error text-danger\\\"></span>\"));\n    $('.subkategori-input:last').attr('data-subkategori-input-index', index); // Tambah attribute data-subkategori-input-index\n    // $('.subkategori-input').last().val('');\n\n    $('.subkategori-input:last').attr('name', \"dynamic_subKategoriInput[]\");\n    $('.input-error:last').attr('id', \"subKategoriInput\".concat(index, \"Error\"));\n    $('.subkategori-link-input').last().attr('name', \"dynamic_subKategoriLinkInput[]\");\n    $('.input-link-error:last').attr('id', \"subKategoriLinkInput\".concat(index, \"Error\"));\n    $('.subkategori-box').last().fadeIn('slow'); // Tampilkan kontennya\n  }\n}\n\nfunction removeSubCategoryInput(elem) {\n  var inputElement = $(elem).next().find('.subkategori-input').last();\n  var index = !isNaN(parseInt($(inputElement).attr('data-subkategori-input-index'))) ? parseInt($(inputElement).attr('data-subkategori-input-index')) : 2; // console.log($(elem).parents('.subkategori-box').nextAll());\n\n  var nextSubKategoriBox = $(elem).parents('.subkategori-box').nextAll();\n  $(elem).parents('.subkategori-box').fadeOut('fast', function () {\n    $(this).remove();\n\n    if (nextSubKategoriBox.length > 0) {\n      $(nextSubKategoriBox).each(function (elementIndex, element) {\n        var currentIndex = $(element).find('.subkategori-input').attr('data-subkategori-input-index') - 1;\n        $(element).find('.subkategori-input').attr('data-subkategori-input-index', currentIndex);\n        $(element).find('.appended-input-title').text(\"Sub Kategori Input \".concat(currentIndex));\n        $(element).find('.input-error').attr('id', \"subKategoriInput\" + currentIndex + \"Error\");\n      });\n    }\n  });\n} // Toggle sidebar dropdown item\n\n\nfunction toggleSidebarDropdown(elem) {\n  var collapse = false;\n\n  if (elem instanceof Element == false && typeof elem !== 'string') {\n    collapse = elem.collapse;\n    elem = elem.target;\n  }\n\n  var parentElem = $(elem).parent(); // Ambil parent elemennya\n\n  var target = $(parentElem).find(\".\".concat($(elem).attr('data-target'))).attr('data-collapse');\n\n  if (target != 'show' || collapse) {\n    $(parentElem).find(\".\".concat($(elem).attr('data-target'))).fadeOut();\n    $(parentElem).find('.fa-caret-right').css({\n      'transform': 'rotate(0deg)',\n      '-moz-transform': 'rotate(0deg)',\n      '-webkit-transform': 'rotate(0deg)'\n    });\n    $(parentElem).find(\".\".concat($(elem).attr('data-target'))).attr('data-collapse', 'show');\n  } else {\n    $(parentElem).find(\".\".concat($(elem).attr('data-target'))).fadeIn();\n    $(parentElem).find(\".\".concat($(elem).attr('data-target'))).attr('data-collapse', 'collapse');\n    $(parentElem).find('.fa-caret-right').css({\n      'transform': 'rotate(90deg)',\n      '-moz-transform': 'rotate(90deg)',\n      '-webkit-transform': 'rotate(90deg)'\n    });\n  }\n} // Toggle sidebar\n\n\nfunction toggleSidebarAnim(elem) {\n  var collapse = false;\n\n  if (elem instanceof Element == false && typeof elem !== 'string') {\n    collapse = elem.collapse;\n    elem = elem.target;\n  }\n\n  if ($(elem).length > 0) {\n    var dataCollapse = $(elem).attr('data-collapse');\n\n    if (dataCollapse.toLowerCase() == \"collapse\" || collapse) {\n      // Sembunyikan sidebar\n      $(elem).attr('data-collapse', \"show\");\n      $(elem).animate({\n        'left': '-599px'\n      }, 800);\n    } else {\n      // Tampilkan sidebar\n      $(elem).attr('data-collapse', \"collapse\");\n      $(elem).animate({\n        'left': '0'\n      }, 800);\n    }\n  }\n}\n\nfunction toggleUserMenuPanel(data) {\n  var target = data;\n  var collapse = false;\n\n  if (target instanceof Object) {\n    target = target.target;\n    collapse = data.collapse;\n  }\n\n  if ($(target).length > 0) {\n    if ($(target).attr(\"data-show\").toLowerCase() == \"hide\" || collapse) {\n      $(target).animate({\n        opacity: 0\n      }, 200, function () {\n        $(this).hide();\n        $(this).attr(\"data-show\", \"show\");\n      });\n    } else {\n      $(target).show(function () {\n        $(this).animate({\n          opacity: 1\n        }, 200);\n        $(this).attr(\"data-show\", \"hide\");\n      });\n    }\n  }\n} // Tutup bootstrap notification alert\n\n\nfunction closeNotification(element) {\n  $(document).on('click', element, function (e) {\n    e.preventDefault();\n    var elem = $(this).parent();\n    $(elem).fadeOut('slow', function () {\n      $(this).remove();\n    });\n  });\n}\n\nfunction showPassword(elem) {\n  var icon = $(elem).children().find('i');\n  var target = $(\"#\".concat($(elem).attr('data-target-password')));\n\n  if ($(icon).hasClass('fa-eye')) {\n    $(icon).removeClass('fa-eye');\n    $(icon).addClass('fa-eye-slash');\n    $(target).attr('type', 'text');\n  } else {\n    $(icon).removeClass('fa-eye-slash');\n    $(icon).addClass('fa-eye');\n    $(target).attr('type', 'password');\n  }\n}\n\nvar Event = new function () {\n  return {\n    addDOMEvent: function addDOMEvent(event, selector) {\n      event.call({}, selector);\n    },\n    execute: function execute(command) {\n      command.execute();\n    }\n  };\n}();\n\n//# sourceURL=webpack:///./src/command-module.js?");

/***/ }),

/***/ "./src/confirmation-dialog-module.js":
/*!*******************************************!*\
  !*** ./src/confirmation-dialog-module.js ***!
  \*******************************************/
...
eval("__webpack_require__(/*! babel-polyfill */\"./node_modules/babel-polyfill/lib/index.js\");\nmodule.exports = __webpack_require__(/*! /var/www/html/admin-store/src/main.js */\"./src/main.js\");\n\n\n//# sourceURL=webpack:///multi_babel-polyfill_./src/main.js?");
