                    ...
                    <div class="card w-100 rounded-0">
                        <div class="card-body">
                            ...
                            <div class="w-100 mt-4">
                                <form action="<?= base_url("produk/input_tambah_produk") ?>" id="formInputSubmit" data-refresh="refresh">
                                    <div class="row">
                                        <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12 mb-2">
                                            <div class="mb-2">
                                                <span>Nama Produk</span>
                                            </div>
                                            <input type="text" class="form-control rounded-0" name="namaProdukInput" id="namaProdukInput" placeholder="Nama Produk">
                                            <div>
                                        ...
                                        <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12 mb-2">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="text" class="form-control rounded-0 money-rupiah" id="hargaProdukInput" name="hargaProdukInput" placeholder="Harga Produk">
                                            </div>
                                            <div>
                                        ...
                                        <div class="col-xl-4 col-lg-4 col-md-4 col-sm-12 col-12 mb-2">
                                            ...
                                            <input type="text" id="stokProdukInput" name="stokProdukInput" class="form-control rounded-0">
                                            <div>
                                        ...
                                        <div class="col-xl-4 col-lg-4 col-md-4 col-sm-12 col-12 mb-2">
                                            ...
                                            <input type="text" id="beratProdukInput" name="beratProdukInput" class="form-control rounded-0">
                                            <div>
                                        ...
                                        <div class="col-xl-4 col-lg-4 col-md-4 col-sm-12 col-12 mb-2">
                                            ...
                                            <div class="input-group">
                                                <input type="text" id="diskonProdukInput" name="diskonProdukInput" class="form-control number-colon-only rounded-0">
                                        ...
                                        <div class="col-12 mb-2">
                                            ...
                                            <textarea name="deskripsiProdukInput" id="deskripsiProdukInput" cols="30" rows="10" class="form-control rounded-0 ckeditor"></textarea>
                                            <div>
